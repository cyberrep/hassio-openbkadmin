...
<html lang="<?php echo $lang; ?>" xmlns="http://www.w3.org/1999/html">
	<head>
		...
		<title><?php echo isset($title) ? $title.' - ' : ''; ?>OpenBKAdmin</title>
		...
		<script src="<?php echo $urlHelper->js('compiled/OpenBeken'); ?>"></script>
					...
					<ul class="navbar-nav me-auto">
						...
						<li class="nav-item dropdown">
							...
							: ''; ?>"
								...
								<?php } ?>
								<a href='https://github.com/openshwprojects/OpenBK7231T_App/blob/main/docs/README.md' target='_blank'
								...
								<a href='https://github.com/openshwprojects/OpenBK7231T_App/blob/main/docs/commands.md' target='_blank'
								   class='dropdown-item nav-link <?php echo in_array(
								       $page,
								       []
								   ) ? 'active' : ''; ?>'
								...
								<a href='https://openbekeniot.github.io/webapp/devicesList.html' target='_blank'
								   class='dropdown-item nav-link <?php echo in_array(
								       $page,
								       []
								   ) ? 'active' : ''; ?>'
								...
								<a href='https://github.com/openshwprojects/OpenBK7231T_App/blob/main/docs/faq.md' target='_blank'
								   class='dropdown-item nav-link <?php echo in_array(
								       $page,
								       []
								   ) ? 'active' : ''; ?>'
								...
								<a href='https://www.elektroda.com/rtvforum/forums.html' target='_blank'
								   class='dropdown-item nav-link <?php echo in_array(
								       $page,
								       []
								   ) ? 'active' : ''; ?>'
								>
									<?php echo __('HELP_DISCORD_OpenBeken', 'NAVI'); ?>
								</a>
