...
>
    ...
    <tr>
        ...
        <th data-column-id='chipset' data-column-label='Chipset' data-column-toggle='true' data-tablesaw-sortable-col>Chipset</th>
        ...
        <th data-column-id='actions' class='link text-sm-right text-nowrap' style='width:1%; white-space:nowrap;'></th>
    </tr>
    </thead>
    <tbody>
    <?php
        ...
        foreach ($device_group->names as $key => $devicename) { ?>
            ...
            ?>
                ...
                >
                    ...
                    <td class='chipset' data-column-id='chipset'>
                                                        <span><?php echo $loadingIndicator; ?></span>
                    </td>
