...
use OpenBKAdmin\Helper\OpenBKAdminHelper;

class OpenBKAdminHelperTest extends TestCase
{
    public function testGetChangelogFetchesReleasesAndConvertsMarkdown(): void
    {
        ...
        $client->expects(self::once())
            ->method('get')
            ->with('https://api.github.com/repos/OpenBKAdmin/OpenBKAdmin/releases')
        ...
        $helper = new OpenBKAdminHelper(new GithubFlavoredMarkdownConverter(), $client);
