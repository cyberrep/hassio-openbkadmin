...
use OpenBKAdmin\SelfUpdate;

if (!defined('_DATADIR_')) {
    define('_DATADIR_', sys_get_temp_dir().'/OpenBKAdmin-selfupdate-tests/data/');
}
if (!defined('_TMPDIR_')) {
    define('_TMPDIR_', sys_get_temp_dir().'/OpenBKAdmin-selfupdate-tests/tmp/');
}
if (!defined('_APPROOT_')) {
    define('_APPROOT_', sys_get_temp_dir().'/OpenBKAdmin-selfupdate-tests/app/');
}
...
class SelfUpdateTest extends TestCase
{
    ...
    public function testUpdateCopiesStableReleaseAndUpdatesVersion(): void
    {
        ...
        $zipPath = $this->createReleaseZip([
            'OpenBKAdmin/' => null,
            'OpenBKAdmin/marker.txt' => 'fresh release',
        ]);
        ...
        self::assertDirectoryDoesNotExist(_TMPDIR_.'OpenBKAdmin');
    }
    ...
    public function testUpdateSkipsCopyOnDevChannelButStillUpdatesVersion(): void
    {
        ...
        $zipPath = $this->createReleaseZip([
            'OpenBKAdmin/' => null,
            'OpenBKAdmin/marker.txt' => 'dev release',
        ]);
    ...
    public function testUpdateStopsWhenPreInstallChecksFail(): void
    {
        ...
        $zipPath = $this->createReleaseZip([
            'OpenBKAdmin/' => null,
            'OpenBKAdmin/marker.txt' => 'should not copy',
            'OpenBKAdmin/includes/' => null,
            'OpenBKAdmin/includes/preinstallchecks.php' => <<<'PHP'
                <?php
                return new class {
    ...
    public function testUpdateReturnsFailureWhenDownloadedFileIsNotAZipArchive(): void
    {
        ...
        self::assertStringContainsString(_DATADIR_.'updates/OpenBKAdmin.zip', implode("\n", $result['logs']));
        self::assertSame('v5.0.0', $config->read('current_git_tag'));
    }
