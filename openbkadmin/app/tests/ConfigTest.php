...
class ConfigTest extends TestCase
{
    ...
    protected function tearDown(): void
    {
        ...
        putenv('OpenBKAdmin_DEVICE_PASSWORD_KEY');
    ...
    {
        putenv('OpenBKAdmin_DEVICE_PASSWORD_KEY='.base64_encode(random_bytes(32)));
        $config = $this->getConfig();
    ...
    public function testConstructorFallsBackToGitDescribeWhenVersionSourcesAreMissing(): void
    {
        ...
        $appRoot = sys_get_temp_dir().'/OpenBKAdmin-config-'.bin2hex(random_bytes(6));
        $binDir = $appRoot.'/bin';
    ...
    public function testConstructorUsesVersionFileWhenPresent(): void
    {
        ...
        $appRoot = sys_get_temp_dir().'/OpenBKAdmin-config-version-'.bin2hex(random_bytes(6));
        $dataDir = $appRoot.'/data';
        mkdir($appRoot);
        mkdir($dataDir);
    ...
    public function testConstructorUsesBuildVersionWhenVersionFileIsMissing(): void
    {
        ...
        $appRoot = sys_get_temp_dir().'/OpenBKAdmin-config-build-'.bin2hex(random_bytes(6));
        $dataDir = $appRoot.'/data';
        mkdir($appRoot);
        mkdir($dataDir);
    ...
    public function testConstructorTrimsBuildVersionWhenVersionFileIsMissing(): void
    {
        ...
        $appRoot = sys_get_temp_dir().'/OpenBKAdmin-config-build-trim-'.bin2hex(random_bytes(6));
        $dataDir = $appRoot.'/data';
        mkdir($appRoot);
        mkdir($dataDir);
    ...
    {
        $appRoot = sys_get_temp_dir().'/OpenBKAdmin-config-docker-'.bin2hex(random_bytes(6));
        $dataDir = $appRoot.'/data';
        mkdir($appRoot);
        mkdir($dataDir);
    ...
    {
        $appRoot = sys_get_temp_dir().'/OpenBKAdmin-config-legacy-'.bin2hex(random_bytes(6));
        $dataDir = $appRoot.'/data';
        mkdir($appRoot);
        mkdir($dataDir);
    ...
    {
        $appRoot = sys_get_temp_dir().'/OpenBKAdmin-config-php-migration-'.bin2hex(random_bytes(6));
        $dataDir = $appRoot.'/data';
        mkdir($appRoot);
        mkdir($dataDir);
    ...
    {
        $appRoot = sys_get_temp_dir().'/OpenBKAdmin-config-php-empty-'.bin2hex(random_bytes(6));
        $dataDir = $appRoot.'/data';
        mkdir($appRoot);
        mkdir($dataDir);
        file_put_contents($dataDir.'/MyConfig.php', "<?php\n\nreturn 1;\n");
    ...
    {
        $appRoot = sys_get_temp_dir().'/OpenBKAdmin-config-backfill-'.bin2hex(random_bytes(6));
        $dataDir = $appRoot.'/data';
        mkdir($appRoot);
        mkdir($dataDir);
        file_put_contents($dataDir.'/MyConfig.json', json_encode([
    ...
    public function testConstructorClearsPersistedGitBranchWhenGitMetadataIsUnavailable(): void
    {
        ...
        $appRoot = sys_get_temp_dir().'/OpenBKAdmin-config-branch-cleanup-'.bin2hex(random_bytes(6));
        $dataDir = $appRoot.'/data';
        mkdir($appRoot);
        mkdir($dataDir);
        file_put_contents($dataDir.'/MyConfig.json', json_encode([
    ...
    public function testConstructorClearsPersistedGitBranchWhenGitReturnsHead(): void
    {
        ...
        $appRoot = sys_get_temp_dir().'/OpenBKAdmin-config-detached-head-'.bin2hex(random_bytes(6));
        $binDir = $appRoot.'/bin';
        $dataDir = $appRoot.'/data';
        mkdir($appRoot);
        mkdir($binDir);
    ...
    public function testConstructorWithBlankVersionFileKeepsExistingTagButClearsBranch(): void
    {
        ...
        $appRoot = sys_get_temp_dir().'/OpenBKAdmin-config-blank-version-'.bin2hex(random_bytes(6));
        $dataDir = $appRoot.'/data';
        mkdir($appRoot);
        mkdir($dataDir);
