...
class OpenBekenTest extends TestCase
{
    ...
    public function testbuildCmndUrlCredentials(): void
    {
        ...
        $OpenBeken = new OpenBeken($this->getTestDeviceRepository(), $this->getClient(), $this->getTestConfig());
        $url = $OpenBeken->buildCmndUrl($device, OpenBeken::COMMAND_INFO_STATUS_ALL);
    ...
    public function testBackupBasicAuthUrlEncodesSpecialCharacters(): void
    {
        ...
        $OpenBeken = new OpenBeken($this->getTestDeviceRepository(), $client, $this->getTestConfig());

        $OpenBeken->backup($device, $this->getBackupDir());
    ...
    public function testGetAllStatusValid(): void
    {
        ...
        $OpenBeken = new OpenBeken($this->getTestDeviceRepository(), $this->getClient([
            new Response(200, [], TestUtils::loadFixture('response-valid.json')),
        ]), $this->getTestConfig());
        $result = $OpenBeken->getAllStatus($device);
    ...
    public function testSearch(): void
    {
        ...
        foreach (range(1, 2) as $count) {
            ...
            $devices[] = $OpenBeken->buildCmndUrl($device, OpenBeken::COMMAND_INFO_STATUS_ALL);
        }

        $result = $OpenBeken->search($devices);
    ...
    public function testDecodeOptionsIncludesMqttDiscovery(): void
    {
        ...
        $result = $OpenBeken->decodeOptions('80000');
    ...
    public function testDecodeOptionsReturnsFalseForEmptyInput(): void
    {
        ...
        self::assertFalse($OpenBeken->decodeOptions(''));
    }
    ...
    public function testGetDevicesBasic(): void
    {
        ...
        $OpenBeken = new OpenBeken($mockRepository, $this->getClient(), $this->getTestConfig());
    ...
    public function testBackup(): void
    {
        ...
        $location = $OpenBeken->backup($device, $this->getBackupDir());
    ...
    public function testBackupReplacesExistingFile(): void
    {
        ...
        $location = $OpenBeken->backup($device, $backupDir);
    ...
    public function testRestoreUsesWebGetConfigCommand(): void
    {
        ...
        $result = $OpenBeken->restore($device, 'http://192.168.1.1:8080/_BASEURL_/actions?downloadRestore=abc123');
    ...
    public function testRepositoryBackedEncryptedPasswordsStillWorkForUrlsAndBackup(): void
    {
        ...
        $OpenBeken = new OpenBeken($repository, $client, $this->getTestConfig());

        self::assertSame(
            'http://192.168.1.8:80/cm?user=user&password=pass&cmnd=status+0',
            $OpenBeken->buildCmndUrl($device, OpenBeken::COMMAND_INFO_STATUS_ALL)
        );
    ...
    public function testGetNtpStatusReturnsEmptyStringWhenCommandIsUnknown(): void
    {
        ...
        self::assertSame('', $OpenBeken->getNTPStatus($device));
    }
    ...
    public function testGetNtpStatusReturnsParsedStatusWhenAvailable(): void
    {
        ...
        self::assertSame('pool.ntp.org', $OpenBeken->getNTPStatus($device)->NtpServer1);
    }
    ...
    public function testMqttValueReadersReturnParsedValues(string $method, string $field, string $expected): void
    {
        ...
        self::assertSame($expected, $OpenBeken->{$method}($device));
    }
    ...
    public function testMqttValueReadersReturnEmptyStringForUnknownCommand(string $method): void
    {
        ...
        self::assertSame('', $OpenBeken->{$method}($device));
    }
    ...
    public function testGetMqttFingerprintReturnsEmptyStringWhenFieldIsMissing(): void
    {
        ...
        self::assertSame('', $OpenBeken->getMqttFingerprint($device));
    }
    ...
    public function testDoAjaxReturnsErrorWhenDeviceDoesNotExist(): void
    {
        ...
        $OpenBeken = new OpenBeken($repository, $this->getClient(), $this->getTestConfig());
        $result = $OpenBeken->doAjax(99, 'Power On');
    ...
    public function testDoAjaxReturnsParsedResponse(): void
    {
        ...
        $OpenBeken = new OpenBeken($repository, $client, $this->getTestConfig());
        $result = $OpenBeken->doAjax(1, 'Power On');
    ...
    public function testSetDeviceValueDelegatesToRepository(): void
    {
        ...
        self::assertSame($device, $OpenBeken->setDeviceValue(1, 'img', 'new-image'));
    }
    ...
    public function testGetPrefixeMixesValuesAndUnknownCommands(): void
    {
        ...
        $result = $OpenBeken->getPrefixe($device);
    ...
    public function testGetStateTextsMixesValuesAndUnknownCommands(): void
    {
        ...
        $result = $OpenBeken->getStateTexts($device);
    ...
    public function testDoAjaxAllReturnsEmptyArrayWhenThereAreNoDevices(): void
    {
        ...
        self::assertSame([], $OpenBeken->doAjaxAll());
    }
    ...
    public function testGetFullTopicRetriesAfterWarningAndReturnsSecondAttempt(): void
    {
        ...
        self::assertSame('%prefix%/%topic%/', $OpenBeken->getFullTopic($device));
    ...
    public function testGetFullTopicReturnsOriginalWarningWhenWeblogRetryStillWarns(): void
    {
        ...
        $OpenBeken = new OpenBeken($this->getTestDeviceRepository(), $client, $this->getTestConfig());
        $result = $OpenBeken->getFullTopic($device);
    ...
    public function testSaveConfigSkipsWarningRetryForBacklogCommands(): void
    {
        ...
        $OpenBeken = new OpenBeken($this->getTestDeviceRepository(), $client, $this->getTestConfig());
        $result = $OpenBeken->saveConfig($device, 'Backlog Template {"NAME":"Demo"}');
    ...
    public function testGetTimersConfigLoadsGlobalToggleAndAllTimers(): void
    {
        ...
        $OpenBeken = new OpenBeken($this->getTestDeviceRepository(), $this->getClient($responses), $this->getTestConfig());
        $result = $OpenBeken->getTimersConfig($device);
    ...
    public function testGetTimersConfigReturnsNullWhenTimersAreUnsupported(): void
    {
        ...
        self::assertNull($OpenBeken->getTimersConfig($device));
    }
    ...
    public function testSaveTimersSendsGlobalToggleAndIndividualTimerCommands(): void
    {
        ...
        $OpenBeken = new OpenBeken($this->getTestDeviceRepository(), $client, $this->getTestConfig());
        $result = $OpenBeken->saveTimers($device, $this->getTimerSettingsPayload());
    ...
    public function testSearchReturnsEmptyArrayWhenNoUrlsAreProvided(): void
    {
        ...
        self::assertSame([], $OpenBeken->search([]));
    }
