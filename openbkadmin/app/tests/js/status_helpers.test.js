...
test("parseUptimeToSeconds parses OpenBeken uptime strings", () => {
...
test("getSortableVersionValue normalizes version strings for semantic sorting", () => {
  assert.equal(
    getSortableVersionValue("14.4.0.1(OpenBeken32)") >
      getSortableVersionValue("9.5.0.4(ethernet)"),
    true,
  );
  assert.equal(
    getSortableVersionValue("14.4.10(OpenBeken)") >
      getSortableVersionValue("14.4.2(OpenBeken)"),
    true,
  );
