...
use OpenBKAdmin\Update\UpdateChecker;
...
class UpdateCheckerTest extends TestCase
{
    ...
    public function testCheckForUpdateBetaUsesReleaseListResponseShape(): void
    {
        ...
        self::assertSame('v1.8.0', $result['latest_tag']);
        self::assertSame(
            'https://github.com/OpenBKAdmin/OpenBKAdmin/releases/download/v1.8.0/OpenBKAdmin_v1.8.0.zip',
            $result['release_url']
        );
    }
    ...
    {
        $request = new Request('GET', 'https://api.github.com/repos/OpenBKAdmin/OpenBKAdmin/releases/latest');
    ...
    private function assertValid(array $result): void
    {
        ...
        self::assertEquals('https://github.com/OpenBKAdmin/OpenBKAdmin/releases/download/v1.8.0/OpenBKAdmin_v1.8.0.zip', $result['release_url']);
    }
