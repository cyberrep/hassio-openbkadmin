...
namespace Tests\OpenBKAdmin\Mqtt;
...
use OpenBKAdmin\Mqtt\MqttClientFactoryInterface;
use OpenBKAdmin\Mqtt\MqttClientInterface;
use OpenBKAdmin\Mqtt\MqttDiscoveryRequest;
use OpenBKAdmin\Mqtt\MqttDiscoveryService;
use OpenBKAdmin\Mqtt\TimeProviderInterface;
...
class MqttDiscoveryServiceTest extends TestCase
{
    ...
    public function testScanReturnsNewOfflineAndConflictBuckets(): void
    {
        ...
        self::assertSame('new-device', $result->newDevices[0]->OpenBKAdminMqttTopic);
    ...
    public function testScanSupportsMultiSegmentPrefixesAndNestedTopics(): void
    {
        ...
        self::assertCount(1, $result->newDevices);
        self::assertSame('downstairs/lamp', $result->newDevices[0]->OpenBKAdminMqttTopic);
