...
class BackupHelper
{
    ...
    public function backup(array $deviceIds): BackupResults
    {
        ...
        foreach ($deviceIds as $deviceId) {
            ...
            try {
                $files[] = $this->OpenBeken->backup($device, $this->backupPath);
    ...
    public function restore(array $deviceIds, ?array $uploadedFile): BackupResults
    {
        ...
        $result = $this->OpenBeken->restore($device, $this->getRestoreDownloadUrl($restoreToken));
