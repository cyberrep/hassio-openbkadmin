...
namespace OpenBKAdmin\OpenBeken;
...
class ResponseParser
{
    public function processResult(string $result): \stdClass
    {
        ...
        if (JSON_ERROR_CTRL_CHAR === json_last_error()) {  // https://github.com/OpenBKAdmin/OpenBKAdmin/issues/78
    ...
    private function compatibility(\stdClass $status): \stdClass
    {
         ...
         * https://github.com/OpenBKAdmin/OpenBKAdmin/issues/107.
         */
    ...
    /**
     * This fixes wrong formatted json answer form OpenBeken Version 5.10.0
    ...
    /**
     * This fixes wrong formatted json answer form OpenBeken Version 8.5.0.x
     * Example wrong format: dev/json_error_8500.json.
     *
     * Shutters missed a } at the end
     * https://github.com/OpenBKAdmin/OpenBKAdmin/issues/398
     */
